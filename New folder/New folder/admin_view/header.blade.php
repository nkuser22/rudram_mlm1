...
<!-- Mirrored from themes.pixelstrap.com/fastkart/back-end/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Aug 2023 06:59:17 GMT -->
<head>
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <a href="{{url('admin/add_new_product')}}">Add New Products</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="{{url('admin/all_users')}}">All users</a>
                                        </li>
                                        {{-- <li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="{{url('admin/order_list')}}">Order List</a>
                                        </li>
                                        <li>
                                            <a href="{{url('admin/order_detail')}}">Order Detail</a>
                                        </li>
                                        {{-- <li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="{{url('admin/profile')}}">Profile Setting</a>
                                        </li>
                                    </ul>
                                </li>
