...
@endphp
  <!-- App css -->
  <link href="{{asset('user/u1/assets/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
         <link href="{{asset('user/u1/assets/css/icons.min.css')}}" rel="stylesheet" type="text/css" />
         <link href="{{asset('user/u1/assets/css/app.min.css')}}" rel="stylesheet" type="text/css" />
        ...
        <script src="https://code.jquery.com/jquery-3.6.4.min.js" integrity="sha384-oA7p5ZYoeFFTo/Djb+MLHXrJ9eZbhI5j+Yld+FfkpHzhfKIOW9T4hQ1ROF85zv6" crossorigin="anonymous"></script>
