								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex flex-column align-items-center text-center">
											...
											@if($user->image)
                                            <img src="{{ asset('storage/' . $user->image) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                            @else
                                                <img src="{{ $Conn->websiteInfo('logo') }}" class="rounded-circle p-1 bg-primary" width="110" alt="user avatar">
                                            @endif
								...
								<div class="card">
                                    ...
                                    @csrf
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text"  name="phone" class="form-control" value="{{ old('phone', $user->mobile) }}"/>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
