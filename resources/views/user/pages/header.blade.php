...
<head>
	...
	<!--plugins-->
	<link href="{{asset('user/u1/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet"/>
	...
	<!-- Theme Style CSS -->
	<link rel="stylesheet" href="{{asset('user/u1/assets/css/dark-theme.css')}}"/>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="{{$Conn->websiteInfo('logo')}}" class="logo-icon" alt="logo icon">
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li class="menu-label">My Team</li>
				<li>
					<a href="{{url('/user-directs')}}">
						<div class="parent-icon"><i class="bx bx-user"></i> 

						</div>
						<div class="menu-title">Directs</div>
					</a>
				</li>

				<li>
					<a href="{{url('/user-teams')}}">
						<div class="parent-icon"><i class="bx bx-group"></i>
                      </div>
						<div class="menu-title">My Teams</div>
					</a>
				</li>
				...
				<li class="menu-label">Fund Section</li>
                <li>
					...
					<ul>
						<li> <a href="{{url('/user-funds')}}" ><i class='bx bx-radio-circle'></i>Add Request</a>
						</li>
						<li> <a href="{{url('/user-funds-history')}}"><i class='bx bx-radio-circle'></i>Request History</a>
						</li>
			...
			<div class="topbar d-flex align-items-center">
				<nav class="navbar navbar-expand gap-3">
					...
					<div class="user-box dropdown px-3">
                        ...
                        @else
                            <img src="{{ $Conn->websiteInfo('logo') }}" class="user-img" alt="user avatar">
                        @endif
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item d-flex align-items-center" href="{{url('/user-profile')}}"><i class="bx bx-user fs-5"></i><span>Profile</span></a>
							</li>
