                                        ...
                                        <div class="product-main no-arrow">
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('front/f1/images/product/category/1.jpg')}}" id="img-1"
                                                        data-zoom-image="{{asset('front/f1/images/product/category/1.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('front/f1/images/product/category/2.jpg')}}"
                                                        data-zoom-image="{{asset('front/f1/images/product/category/2.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('front/f1/images/product/category/3.jpg')}}"
                                                        data-zoom-image="{{asset('front/f1/images/product/category/3.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('front/f1/images/product/category/4.jpg')}}"
                                                        data-zoom-image="{{asset('front/f1/images/product/category/4.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('front/f1/images/product/category/5.jpg')}}"
                                                        data-zoom-image="{{asset('front/f1/images/product/category/5.jpg')}}" class="
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('front/f1/images/product/category/6.jpg')}}"
                                                        data-zoom-image="{{asset('front/f1/images/product/category/6.jpg')}}" class="
                                        ...
                                        <div class="left-slider-image left-slider no-arrow slick-top">
                                            <div>
                                                <div class="sidebar-image">
                                                    <img src="{{asset('front/f1/images/product/category/1.jpg')}}"
                        ...
                        <div class="vendor-box">
                            <div class="verndor-contain">
                                <div class="vendor-image">
                                    <img src="{{asset('front/f1/images/product/vendor.png')}}" class="blur-up lazyload" alt="">
                                </div>
                                ...
                                <ul>
                                        ...
                                        <div class="product-box product-box-bg wow fadeInUp">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{asset('front/f1/images/cake/product/1.png')}}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="product-box product-box-bg wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{asset('front/f1/images/cake/product/2.png')}}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                            <div class="product-detail">
                                    ...
                                    <li>
                                        <div class="product-box product-box-bg wow fadeInUp">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{asset('front/f1/images/cake/product/3.png')}}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                            </div>
                                            <div class="product-detail">
                            ...
                            <div class="tab-pane fade show active" id="description" role="tabpanel"
                                ...
                                <div class="product-description">
                                    ...
                                    <div class="banner-contain nav-desh">
                                        <img src="{{asset('front/f1/images/vegetable/banner/14.jpg')}}"
                                                ...
                                                <ul class="review-list">
                                                        ...
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image">
                                                                    <img src="{{asset('front/f1/images/review/1.jpg')}}"
                                                                        class="img-fluid blur-up lazyload" alt="">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image">
                                                                    <img src="{{asset('front/f1/images/review/2.jpg')}}"
                                                                        class="img-fluid blur-up lazyload" alt="">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="people-box">
                                                            <div>
                                                                <div class="people-image">
                                                                    <img src="{{asset('front/f1/images/review/3.jpg')}}"
                                                                        class="img-fluid blur-up lazyload" alt="">
                                                                </div>
                                                            </div>
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-2.html">
                                            <img src="{{asset('front/f1/images/cake/product/11.png')}}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{asset('front/f1/images/cake/product/4.png')}}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{asset('front/f1/images/cake/product/5.png')}}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{asset('front/f1/images/cake/product/6.png')}}"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="{{asset('front/f1/images/cake/product/7.png')}}" class="img-fluid" alt="">
                                        </a>
